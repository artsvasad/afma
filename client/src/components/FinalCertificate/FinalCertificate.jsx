...
<!---HIDING MERIT POSITION FOR TEMPORARY--->


          <div className="info-item merit-position" style={{ color: '#c53030', display:'hide'}}><strong>Merit Position:</strong> {student.meritPosition}</div>
        </div>
      </header>
